...
class ThemeProvider extends InheritedWidget {
  ...
  ThemeData light([Color? targetColor]) {
    final colorsLocal = colors(Brightness.light, targetColor);
    return ThemeData.light().copyWith(
      pageTransitionsTheme: pageTransitionsTheme,
      colorScheme: colorsLocal,
      appBarTheme: appBarTheme(colorsLocal),
      cardTheme: cardTheme(),
      listTileTheme: listTileTheme(colorsLocal),
      tabBarTheme: tabBarTheme(colorsLocal),
      scaffoldBackgroundColor: colorsLocal.surface,
    );
  }

  ThemeData dark([Color? targetColor]) {
    final colorsLocal = colors(Brightness.dark, targetColor);
